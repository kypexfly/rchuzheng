  ...
  return (
    <section className="my-8">
      ...
      <p className="max-w-prose mb-10 font-normal text-gray-700 dark:text-gray-300 leading-relaxed">
        I am a 23-year-old graduate student in Electrical Engineering. From a young age, I have been fascinated by the
        intricacies of web development, exploring programming languages such as Javascript, Python, and utilizing tools
        like MATLAB/R for scientific and engineering applications.
      </p>
      <p className="max-w-prose mb-10 font-normal text-gray-700 dark:text-gray-300 leading-relaxed">
